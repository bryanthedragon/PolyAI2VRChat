...
{
    public interface IAvatarPolyBuzz
    {
    ...
    public class AvatarProperties : IAvatarPolyBuzz
    {
        public string Name { get; set; }
        public string Description { get; set; }
        public string AvatarId { get; set; }
        ...
        public void CloneAvatar(Object Avatar)
        {
            ...
            {
                IAvatarBase clonedAvatar = new VRChatAvatar();
            }
        }
        ...
        /// <summary>
        /// Untags the avatar with the given tags.
        /// </summary>
        /// <param name="Avatar">The avatar to untag</param>
        /// <param name="tags">The tags to remove from the avatar</param>
        /// <remarks>
        /// The avatar is untagged if it is valid and the tags are not null or empty.
        /// A message is printed to the console when the avatar is untagged.
        /// </remarks>
    ...
    public sealed class PolyBuzzAvatar : IAvatarPolyBuzz
    {
        public string Name { get; set; }
        public string Description { get; set; }
        public string AvatarId { get; set; }
