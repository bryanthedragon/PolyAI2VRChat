...
namespace PolyBuzzToVRChat.AI.Integrater
{
    public class AIIntegrater
    {
        ...
        public class PersonalityIntegrate : IAIPersonality
        {
            ...
            PersonalityType IAIPersonality.getPersonalityType()
            {
        ...
        public class EmotionIntegrate : IAIEmotion
        {
            ...
            EmotionType IAIEmotion.SetEmotion(EmotionType emotion)
            {
                return emotion;
            }
        }
        ...
        public class TaskIntegrate : IAITask
        {
            ...
            TaskGroupType IAITask.getTaskGroupType()
            {
                return TaskGroupType.None;
            }

            TaskActionType IAITask.GetTaskActionType()
            {
                return TaskActionType.None;
            }
        }
