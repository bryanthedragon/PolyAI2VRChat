...
namespace PolyBuzzToVRChat.Platform.Generics.AI
{
    ...
    public sealed class AIProperties : IAI
    {
        ...
        /// <summary>
        /// Constructor for AIProperties
        /// </summary>
        /// <param name="intent">The intent of the AI</param>
        /// <param name="goal">The goal of the AI</param>
        /// <param name="emotion">The emotion of the AI</param>
